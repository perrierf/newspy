        ...
        if connection.is_connected():
            ...
            for iart in range(len(sourcearts)):
                ...
                for article in sourcearts[iart].articles:
                    ...
                    print(artkeys)
                    sqlinsert = "INSERT INTO articles (source, title, url, description, imgsrc, authors, keywords) VALUES (%s, %s, %s, %s, %s, %s, %s)"
                    valuessql = (newartsrc, arttitle, arturl, artsum, artimg, artauthor, artkeys)
                    try:
